...
<body>
  ...
  <input id="" style=" border-radius: 1px; height: 32px; width: 80%;"  class="ms-1 pe-0 form-control text-dark me-1 searchh2 bg-transparent mt-1" type="text" placeholder="Rc ids" aria-label="Search">
   ...
   <!-- //<div class="offcanvas offcanvas-end show" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel"> -->
    ...
    <div class="rcidsborder Hh" id="1"><i class="bi ms-2 text-danger bi-exclamation-triangle-fill"></i><div class="tits2 ms-2">
...
<ul id="list" class="list-group mb-5 mx-3 mt-2">
        <li style="top: 60px;" class="list-group-item active col-sm-4 col-lg-6 mb-1 fixed-top mx-3">Tasks 
            <span class="badge update bg-danger">0</span>
           
            <button class="btn float-end"></button>
      
          
        </li>
        <li class="list-group-item mt-4 dark_idlist">
            <h4 class="h5 please_text text-muted"></h4>
            <div class="w-100">
...
<script>
  ...
  let dark_bg = document.querySelector('body');
  ...
  function dark(){
    ...
    dark_bg.classList.toggle('bg-dark')
    document.querySelector('.Tasks').classList.toggle('bg-dark')
    document.querySelector('.navbar').classList.toggle('bg-dark')
    document.querySelector('.dark_idlist').classList.toggle('bg-dark') 
    document.querySelector('input').classList.toggle('text-light') 
    document.querySelector('input').classList.remove('text-dark') 
    document.querySelector('.please_text').classList.toggle('text-white-50') 
    
  }
  if (localStorage.getItem("data", "dark")) {
    dark()
  }
</script>
