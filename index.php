...
<body>
  <div class="">
  <nav style="box-shadow: 1px 1px 15px black;" class="navbar bg-light " id="item">
  <div class=" container-fluid">
    <form class="w-100 d-flex" role="search">
   
    <a class="navbar-brand" href="#">
      <i style="height: px;" class="w-100 h-100 bg-dark fa-solid text-white fa-arrow-left-long"></i>
    </a>
  ...
  <input id="" style=" border-radius: 1px; height: 32px; width: 80%;"  class="ms-3 pe-0 form-control text-dark me-1 searchh2 bg-transparent" type="number" placeholder="Rc ids" aria-label="Search">
